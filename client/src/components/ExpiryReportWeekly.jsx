...
export default function ExpiryReportWeekly() {
    ...
    return (
        <div>
            ...
            <div className={"screen:hidden text-xl pl-1"}>Store Spoilage log - {monthNames[parseInt(params.reportDate.substring(0,2)) - 1]} {params.reportDate.substring(2,4)}, {params.reportDate.substring(4,8)} to {monthNames[parseInt(params.reportDate.substring(8,10)) - 1]} {params.reportDate.substring(10,12)}, {params.reportDate.substring(12,16)}</div>
